...
import static com.wemap.wemapgl.WeMapPlugin.CREATED;
import static com.wemap.wemapgl.WeMapPlugin.DESTROYED;
import static com.wemap.wemapgl.WeMapPlugin.PAUSED;
import static com.wemap.wemapgl.WeMapPlugin.RESUMED;
import static com.wemap.wemapgl.WeMapPlugin.STARTED;
import static com.wemap.wemapgl.WeMapPlugin.STOPPED;

import com.mapbox.mapboxsdk.plugins.localization.LocalizationPlugin;

/**
 * Controller of a single WeMaps MapView instance.
 */
final class WeMapController
    implements Application.ActivityLifecycleCallbacks, MapboxMap.OnCameraIdleListener, MapboxMap.OnCameraMoveListener,
    MapboxMap.OnCameraMoveStartedListener, OnAnnotationClickListener, MapboxMap.OnMapClickListener, WeMapOptionsSink,
    MethodChannel.MethodCallHandler, com.mapbox.mapboxsdk.maps.OnMapReadyCallback, OnCameraTrackingChangedListener,
    OnSymbolTappedListener, OnLineTappedListener, OnCircleTappedListener, PlatformView {
  ...
  WeMapController(int id, Context context, AtomicInteger activityState, PluginRegistry.Registrar registrar,
    ...
    methodChannel = new MethodChannel(registrar.messenger(), "plugins.flutter.io/wemap");
  ...
  private static String getAccessToken(@NonNull Context context) {
    try {
      ...
      Log.e(TAG, "Failed to find an Access Token in the Application meta-data." + e.getMessage());
    }
    return null;
  }
